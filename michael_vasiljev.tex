...
\social[linkedin]{michael-vasiliev-a548422b7} 
...
Инструменты: python, transformers, EfficientNet, MobileNet, YOLO, PyOD, pandas, sklearn, pytorch, lightning, numpy, matplotlib, plotly, huggingface, onnx, fastapi, uvicorn, pyinstaller, pywin32, optimum, airflow, mlflow, cvat, natasha, deeppavlov, BERT, whisper, Ollama.\newline{}
\begin{itemize}
...
\section{Пет-проекты}
\cventry{2024—2024}{Тим-лид и технический эксперт}{CheckDocAI}{Москва}{}{Проект: Телеграм-бот с ИИ модулем для контроля качества оформления документов для ООО «Гольфстрим»\newline{}\newline{}
...
\section{Образование}
\cventry{2024—2024}{Анализ данных на языке SQL}{УЦ «Специалист»}{Москва}{повышение квалификации}{}
\cventry{2022—2023}{Computer Vision Engineer}{Deep Learning School ФПМИ МФТИ}{Москва}{профессиональная переподготовка}{}
\cventry{2022—2022}{Специалист по Data Science}{Яндекс Практикум}{Москва}{профессиональная переподготовка}{}
